/**
 * @file perft.c
 * @author H.G. Muller - Minimalist Chess (home.hccnet.nl/h.g.muller)
 * @brief Super fast move generator
 * @version ?
 * @date ?
 * 
 * @copyright Copyright (c) H.G. Muller
 * 
 * Not my code, added here to be able to compile from source
 * 
 */
#include <time.h>
#include <stdio.h>
