...
pub const PSQTS : [[PhasedScore; NumberOf::SQUARES]; NumberOf::PIECE_TYPES] = [
    // King
    [
        S(  17,  -87), S(  -9,  -35), S(  22,  -26), S(-115,   23), S( -62,    4), S( -10,    6), S(  37,   -1), S( 147, -109),
    ...
    // Queen
    [
        S( 724, 1206), S( 732, 1218), S( 762, 1235), S( 795, 1221), S( 795, 1219), S( 799, 1212), S( 818, 1168), S( 765, 1199),
        S( 762, 1170), S( 738, 1214), S( 746, 1246), S( 739, 1264), S( 744, 1281), S( 781, 1241), S( 760, 1226), S( 804, 1200),
        S( 762, 1181), S( 760, 1198), S( 757, 1240), S( 773, 1242), S( 778, 1256), S( 819, 1235), S( 820, 1198), S( 817, 1186),
        S( 746, 1190), S( 750, 1213), S( 754, 1228), S( 752, 1252), S( 754, 1264), S( 767, 1250), S( 767, 1236), S( 773, 1214),
        S( 747, 1187), S( 745, 1217), S( 744, 1226), S( 752, 1245), S( 751, 1244), S( 750, 1235), S( 761, 1215), S( 764, 1202),
        S( 744, 1177), S( 752, 1193), S( 747, 1216), S( 746, 1214), S( 749, 1217), S( 756, 1209), S( 768, 1187), S( 762, 1175),
        S( 743, 1172), S( 748, 1176), S( 758, 1173), S( 758, 1183), S( 756, 1186), S( 765, 1159), S( 770, 1132), S( 781, 1102),
        S( 741, 1165), S( 731, 1173), S( 738, 1176), S( 753, 1168), S( 744, 1172), S( 731, 1171), S( 754, 1141), S( 746, 1141),
    ],
    // Rook
    [
        ...
        S( 369,  642), S( 389,  645), S( 391,  647), S( 394,  645), S( 422,  633), S( 423,  626), S( 460,  618), S( 438,  613),
        S( 354,  644), S( 367,  643), S( 369,  652), S( 377,  649), S( 383,  634), S( 383,  628), S( 392,  624), S( 395,  617),
        S( 335,  637), S( 337,  642), S( 347,  644), S( 359,  643), S( 359,  639), S( 344,  637), S( 367,  624), S( 359,  619),
        S( 328,  633), S( 337,  633), S( 346,  632), S( 345,  637), S( 350,  633), S( 348,  625), S( 381,  605), S( 361,  606),
        S( 325,  628), S( 337,  632), S( 352,  632), S( 348,  634), S( 353,  626), S( 355,  622), S( 371,  613), S( 343,  618),
        S( 344,  623), S( 345,  632), S( 355,  640), S( 360,  639), S( 364,  631), S( 354,  626), S( 368,  622), S( 346,  615),
    ],
    // Bishop
    [
        S( 273,  352), S( 255,  363), S( 266,  361), S( 226,  374), S( 236,  368), S( 254,  359), S( 283,  352), S( 246,  350),
        S( 289,  340), S( 312,  359), S( 307,  363), S( 290,  365), S( 319,  356), S( 318,  355), S( 309,  363), S( 298,  338),
        ...
        S( 297,  353), S( 299,  354), S( 309,  352), S( 289,  367), S( 296,  368), S( 308,  357), S( 314,  359), S( 301,  334),
        S( 276,  336), S( 295,  354), S( 280,  335), S( 272,  357), S( 276,  353), S( 275,  353), S( 299,  340), S( 286,  324),
    ],
    // Knight
    [
        ...
        S( 269,  333), S( 302,  348), S( 319,  364), S( 330,  365), S( 366,  350), S( 368,  344), S( 325,  338), S( 294,  323),
        ...
        S( 221,  320), S( 233,  336), S( 249,  344), S( 260,  348), S( 261,  347), S( 264,  343), S( 251,  327), S( 248,  331),
    ...
    [
        ...
        S(  64,  215), S(  75,  224), S( 108,  188), S( 114,  167), S( 117,  159), S( 137,  146), S( 117,  192), S(  76,  190),
